...
program
    .version('1.0.0', 'Mostra a versao do C-Meet Manager')
    ...
    .option('-s, --search <searchEventOptions>', 'Atualiza os dados de uma reuniao')
    .option('Usuarios: ')
    .option('-cs, --createUser <values> <adminPassword>', 'Cria um novo usuario')
    .option('-ru, --readUsers <adminPassword>', 'Mostra todas os usuarios')
    .option('-uu, --updateUsers <values> <adminPassword>', 'Atualiza os dados de um usuario')
    .option('-du, --deleteUsers <id> <adminPassword>', 'Deleta um usuario')
    .option('-su, --searchUsers <searchUserOptions> <adminPassword>', 'Atualiza os dados de uma reuniao')
    .option('                                                ')
    ...
    .option('Valores para cadastrar e pesquisar por usuarios (somente administrador): ', 'name, email, eventCreatorId')
    .option('-ca, --cadmin <password> <adminDeletePassword>', 'Cadastra o usuario administrador')
    .option('-adel, --adminDelete <password> <adminDeletePassword>', 'Cadastra o usuario administrador')
    .parse(process.argv);
